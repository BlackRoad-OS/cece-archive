...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/cece-archive.git
cd cece-archive

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/cece-archive.git
